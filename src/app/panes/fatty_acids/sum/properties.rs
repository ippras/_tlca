use crate::{
    ...
    r#const::id::{
        INDEX, NAME, PROPERTIES, PROPERTY, STEREOSPECIFIC_NUMBER, STEREOSPECIFIC_NUMBERS2,
        STEREOSPECIFIC_NUMBERS13, STEREOSPECIFIC_NUMBERS123,
    },
};
...
impl<'a> Properties<'a> {
    ...
    pub fn show(&mut self, ui: &mut Ui) -> Response {
        let id_salt = Id::new(ID_SOURCE).with(PROPERTIES);
    ...
    fn header_cell_content_ui(&mut self, ui: &mut Ui, row: usize, column: Range<usize>) {
        ...
        match (row, column) {
            ...
            (0, top::PROPERTY) => {
                ui.heading(ui.localize(formatcp!("{PROPERTY}?PluralCategory=one")))
                    .on_hover_ui(|ui| {
                        ui.localize(formatcp!("{PROPERTY}.hover"));
                    });
            }
        ...
        match (row, column) {
            ...
            (row, top::STEREOSPECIFIC_NUMBERS123) => {
                Float64Array::builder()
                    ...
                    .standard_deviation(self.settings.std())
                    .build()
                    .show(ui)?;
            }
...
mod top {
    ...
    pub(super) const PROPERTY: Range<usize> = INDEX.end..INDEX.end + 1;
    pub(super) const STEREOSPECIFIC_NUMBERS123: Range<usize> = PROPERTY.end..PROPERTY.end + 1;
